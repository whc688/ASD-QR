...
import torch
import os
from scalingup.algo.IQL_SAC_algo import IqlSacTrainingAlgo
...
def setup_trainer(
    ...
    if conf.load_from_path is not None:
        algo = IqlSacTrainingAlgo.load_from_checkpoint(
...
@hydra.main(config_path="config", config_name="train_IQL_SAC", version_base="1.2")

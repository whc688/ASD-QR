...
class CriticTrainingAlgo(LightningModule):
    def __init__(
        ...
        self.actor = self.load_actor(actor_checkpoint_path, actor_inference_device)  # DiffusionPolicy
    ...
    def on_load_checkpoint(self, checkpoint: Dict[str, Any]) -> None:
        ...
        # critic1_target
        critic1_target_keys = [k for k in checkpoint["state_dict"].keys() if "lang_embs_cache" in k and "critic1_target." in k]
        ...
        # critic2_target
        critic2_target_keys = [k for k in checkpoint["state_dict"].keys() if "lang_embs_cache" in k and "critic2_target." in k]

...
import torch
import os
from scalingup.algo.actor_only_algo_multiGPU import ActorTrainingAlgo
...
def setup_trainer(
    ...
    if conf.load_from_path is not None:
        algo = ActorTrainingAlgo.load_from_checkpoint(
        ...
        raise ValueError("Must load from path")
...
@hydra.main(config_path="config", config_name="train_actor_only", version_base="1.2")
